-- Objective 3 - Determine the share of renewable energy sources on the entire
...
FROM public."2_canton_sum_charging_stations_occupancy"),
cteRenewables as (
...
FROM public."3_cantons_renewable_charging_shares";
--- correct!

-- from view "4_regions_renewable_charging_shares"
SELECT sum(sum_kwh_at_charging_stations), sum(renewable_power_kwh)
FROM public."3_regions_renewable_charging_shares";
--- correct!
